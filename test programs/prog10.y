/* accepts a regex and prints the RMD (parse tree) 
to run - yacc -d prog.y; cc y.tab.c y.tab.h -ll; 
input - a+|b*|(b.c*) < '.' is a separator*/
...
int yyerror() /*Function to alert user of invalid regular expressions*/
{
